...
public class MainProblem5 {
	...
	public static void main(String[] args) {
		...
		emps.add(new Employeee("12", Arrays.asList(rAccount1, sAccount1)));
		emps.add(new Employeee("31", Arrays.asList(rAccount2, cAccount2)));
		emps.add(new Employeee("42", Arrays.asList(rAccount3, cAccount3, sAccount3)));
		emps.add(new Employeee("33", Arrays.asList(rAccount4, sAccount4, cAccount4)));
